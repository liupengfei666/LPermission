...
import com.lewis.lpermission.google.PermissionUtil;
import com.lewis.lpermission.google.RuntimePermissionsFragment;
import com.lewis.lpermission.google.camera.CameraPreviewFragment;
import com.lewis.lpermission.google.contacts.ContactsFragment;
...
//                        .show();
//            }
            LPermission.onPermissionResult(this, REQUEST_CONTACTS, permissions, grantResults);
    ...
    @PermissionGranted(REQUEST_CONTACTS)
    void requestContactsSuccess() {
        Toast.makeText(this, "成功", Toast.LENGTH_LONG).show();
        showContactDetails();
    }

    @PermissionDenied(REQUEST_CONTACTS)
    void requestContactsFail() {
        Toast.makeText(this, "失败", Toast.LENGTH_LONG).show();
    }

    @PermissionRationale(REQUEST_CONTACTS)
    void ranationale() {
        Toast.makeText(this, "Rationale", Toast.LENGTH_LONG).show();
    }

    @PermissionNeverAskAgain(REQUEST_CONTACTS)
    void neverAskAgain() {
